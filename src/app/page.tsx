...
import { BLUR_BUTTON_VARIANT, FADE_DOWN_ANIMATION_VARIANTS } from "@/lib/variants";
...
const page = () => {
  ...
  return (
    <main className="flex lg:flex-row flex-col-reverse items-center justify-around max-w-screen min-h-screen lg:px-24 px-5 overflow-hidden">
  <motion.div
    className="w-[calc(100% - 1100px + 180px)] h-full"
    initial="hidden"
    animate="show"
    viewport={{ once: true }}
    variants={{
  ...
  <div ref={scope} className="w-2/3 xl:p-32 p-2 lg:mb-0 mb-10 xl:mt-0 lg:mt-32 mt-5">
    <svg
